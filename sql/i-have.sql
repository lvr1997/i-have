...
-- 正在导出表  ihave.category 的数据：~4 rows (大约)
...
CREATE TABLE IF NOT EXISTS `goods` (
  ...
  `publish_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发布时间',
...
INSERT INTO `goods` (`id`, `cate_id`, `user_id`, `name`, `price`, `real_price`, `start_time`, `publish_time`, `end_time`, `first_image`, `phone_number`, `good_buy_method`, `good_address`, `view_count`, `describle`, `status`, `seller_note`) VALUES
	(1, 1, 1, 'Lenovo笔记本', 1000, 3999, '2019-05-19', '2019-05-20', NULL, NULL, '15124680346', '3', '9舍', 13, 'Lenovo笔记本  固态硬盘128', 0, NULL),
	(2, 1, 3, 'oppor9s手机', 800, 1399, '2019-05-23', '2019-05-23', NULL, NULL, '13019711506', '3', '学生公寓', 8, 'oppor9s手机，用了一年', 2, NULL);
...
INSERT INTO `roles` (`id`, `role_id`, `role_name`, `commet`, `create_date`) VALUES
	(1, 'STUDENT', '学生用户', '学生角色，用登录学生端系统', '2022-02-22'),
	(2, 'ADMIN', '系统管理员', '配置学校信息', '2022-02-22'),
	(3, 'AUDITOR', '审核员', '用户审核学生发布的物品信息', '2022-02-22'),
	(4, 'SUPERMANAGER', '超级管理员', '具有全部操作权限', '2022-02-22');
...
-- 正在导出表  ihave.user 的数据：~9 rows (大约)
INSERT INTO `user` (`id`, `user_id`, `phone`, `username`, `password`, `create_at`, `last_login`, `status`, `birthday`, `sex`, `img_url`, `residence`, `signature`, `role_id`) VALUES
	...
	(3, 'fdsdfsd', '13019711506', '西瓜味的小仙', 'E10ADC3949BA59ABBE56E057F20F883E', '2019-05-23', '2026-01-16', 1, '1989-05-26', '男', 'default.png', '黑龙江-哈尔滨市-松北区', '', 'STUDENT'),
	...
	(5, 'dghfgh', '13703111234', '詹三_审核员', 'E10ADC3949BA59ABBE56E057F20F883E', '2020-12-23', NULL, 1, '1998-07-12', '男', 'default.png', NULL, NULL, 'AUDITOR'),
	(6, 'fghgjgjgu', '17765432111', '张三_系统管理员', 'E10ADC3949BA59ABBE56E057F20F883E', '2020-12-22', NULL, 1, '', '男', 'default.png', NULL, NULL, 'ADMIN'),
	(7, 'fdfrhh', '13207111234', '李四_超级管理员', 'E10ADC3949BA59ABBE56E057F20F883E', '2020-12-23', NULL, 1, '', '男', 'default.png', NULL, NULL, 'SUPERMANAGER'),
	(8, '085889', '13212341234', 'test123', 'E10ADC3949BA59ABBE56E057F20F883E', '2025-12-24', '2026-01-16', 0, '', '男', '', NULL, NULL, 'AUDITOR'),
	(11, '894445', '13211225522', '13211225522', 'E10ADC3949BA59ABBE56E057F20F883E', '2026-01-16', '2026-01-16', NULL, NULL, NULL, NULL, NULL, NULL, 'STUDENT');
